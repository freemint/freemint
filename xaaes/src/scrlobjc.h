...
int set_scroll(XA_CLIENT *client, OBJECT *form, int objc);
...
void click_scroll_list(LOCK lock, OBJECT *form, int objc, struct moose_data *md);
void dclick_scroll_list(LOCK lock, OBJECT *form, int objc, struct moose_data *md);
