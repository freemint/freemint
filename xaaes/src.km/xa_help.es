...
W             Rotar ventanas
X             Ocultar todo menos la aplicaci¢n activa
Y             Ocultar aplicaci¢n activa
...
CURSOR-ARRIBA Aumentar tama¤o ventana
CURSOR-ABAJO  Disminuir tama¤o ventana
...
ALT+ " + "    Incrementar el tama¤o de la fuente
ALT+ " - "    Reducir el tama¤o de la fuente
<u>                                                      </u>
...
SHIFT+
 CURSOR-ARRIBA/ABAJO    P gina arriba/abajo
 CURSOR-IZQ/DRECHA      P gina izquierda/derecha

<u>Cuadro de lista de selecci¢n activo</u>:

  CURSOR-DERECHA            Abrir  rbol
  CURSOR-IZQUIERDA          Colapsar  rbol
  CURSOR ARRIBA/ABAJO       Mover cursor
  PageUp/Down(SHIFT+CU/CD)  Paginar la lista de ficheros
  CLEAR/HOME                Saltar al primer elemento
                            en la lista
  SHIFT+CLEAR/HOME          Saltar al £ltimo elemento
                            de la lista

<u>Cuadro de lista de selecci¢n no activo</u>:
...
selecci¢n, CURSOR-DERECHA activa el campo de edici¢n
para que la selecci¢n pueda ser editada.
<u>                                                      </u>

<b>Barra de men£s</b>:

Si est  configurado, el men£ puede ser ocultado (on/off)
clicando sobre el borde superior de la pantalla. Si se
clica en la parte superior izquierda el men£ ser 
