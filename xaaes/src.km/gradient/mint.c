...
struct xa_gradient popbkg_gradient =
{
	...
	3, 1, {-40, 0},
	{{600,650,800}, {700,750,900}, {500,650,700}},
};
...
struct xa_gradient text_gradient =
{
	...
	4, 1, { -40, 0},	/* n_steps < 0: disabled */
	{{500,800,700},{600,800,900},{500,800,700}}
};
short stop = STOP;
