/*
 * resource set indices for style
 *
...
#  endif
#endif
extern _WORD style_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD style_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD style_rsc_free(void);
#endif
