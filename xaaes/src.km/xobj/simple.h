/*
 * resource set indices for simple
 *
...
#undef RSC_NAME
#ifndef __ALCYON__
#define RSC_NAME "simple"
#endif
#undef RSC_ID
#ifdef simple
#define RSC_ID simple
#else
#define RSC_ID 0
#endif
...
#  endif
#endif
extern _WORD simple_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD simple_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD simple_rsc_free(void);
#endif
