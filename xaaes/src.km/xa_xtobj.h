/*
 * resource set indices for xa_xtobj
 *
 ...
 * Number of Images:         0
 * Total file size:          3464
 */

#undef RSC_NAME
#ifndef __ALCYON__
#define RSC_NAME "xa_xtobj"
#endif
#undef RSC_ID
#ifdef xa_xtobj
#define RSC_ID xa_xtobj
#else
#define RSC_ID 0
#endif
...
#define EXT_AESOBJ                         0 /* unknown form */
...
#  endif
#endif
extern _WORD xa_xtobj_rsc_load(_WORD wchar, _WORD hchar);
extern _WORD xa_xtobj_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD xa_xtobj_rsc_free(void);
#endif
