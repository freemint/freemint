...
struct xa_vdi_api
{
	...
	void _cdecl (*set_clip)		(struct xa_vdi_settings *v, const GRECT *clip);
	void _cdecl (*clear_clip)	(struct xa_vdi_settings *v);
	void _cdecl (*restore_clip)	(struct xa_vdi_settings *v, const GRECT *s);
	void _cdecl (*save_clip)	(struct xa_vdi_settings *v, GRECT *s);
	...
	void _cdecl (*draw_texture)	(struct xa_vdi_settings *v, struct xa_mfdb *texture, GRECT *r, GRECT *anchor);

	void _cdecl (*box)			(struct xa_vdi_settings *v, short d, short x, short y, short w, short h);
	void _cdecl (*gbox)			(struct xa_vdi_settings *v, short d, const GRECT *r);
	void _cdecl (*rgbox)		(struct xa_vdi_settings *v, short d, short rnd, const GRECT *r);
	void _cdecl (*bar)			(struct xa_vdi_settings *v, short d, short x, short y, short w, short h);
	void _cdecl (*gbar)			(struct xa_vdi_settings *v, short d, const GRECT *r);
	void _cdecl (*p_gbar)		(struct xa_vdi_settings *v, short d, const GRECT *r);

	void _cdecl (*top_line)		(struct xa_vdi_settings *v, short d, const GRECT *r, short col);
	void _cdecl (*bottom_line)	(struct xa_vdi_settings *v, short d, const GRECT *r, short col);
	void _cdecl (*left_line)	(struct xa_vdi_settings *v, short d, const GRECT *r, short col);
	void _cdecl (*right_line)	(struct xa_vdi_settings *v, short d, const GRECT *r, short col);
	void _cdecl (*tl_hook)		(struct xa_vdi_settings *v, short d, const GRECT *r, short col);
	void _cdecl (*br_hook)		(struct xa_vdi_settings *v, short d, const GRECT *r, short col);

	void _cdecl (*write_disable)	(struct xa_vdi_settings *v, GRECT *r, short colour);
	...
	void _cdecl		(*wtxt_output)		(struct xa_vdi_settings *v, struct xa_wtxt_inf *wtxti, char *txt, short state, const GRECT *r, short xoff, short yoff);

	void _cdecl (*form_save)	(short d, GRECT r, void **area);
	void _cdecl (*form_restore)	(short d, GRECT r, void **area);
	void _cdecl (*form_copy)	(const GRECT *from, const GRECT *to);

	void _cdecl (*r2pxy)		(short *p, short d, const GRECT *r);
	void _cdecl (*rtopxy)		(short *p, const GRECT *r);
