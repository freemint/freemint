...
#define TO_STRNOTFOUND                     4 /* TEXT in tree TOOLBAR */ /* max len 11 */
...
/* [2][Chcete odstranit|%s|z va¹ich zálo¾ek?][  Ano  |  Ne  ] */

#define ASK_SETMARK                        2 /* Alert string */
/* [2][Chcete pøidat|%s|do va¹ich zálo¾ek?][  Ano  |  Ne  ] */

#define ASK_SAVEMARKFILE                   3 /* Alert string */
/* [2][Ulo¾it zálo¾ky?][  Ano  |  Ne  ] */

#define WARN_NORESULT                      4 /* Alert string */
/* [1][HypView: nemohu najít|<%s>][ Zru¹it ] */

#define FSLX_LOAD                          5 /* Free string */
/* Vyberte hypertext k naètení: */
...
#  endif
#endif
extern _WORD cs_rsc_load(void);
extern _WORD cs_rsc_gaddr(_WORD type, _WORD idx, void *gaddr);
extern _WORD cs_rsc_free(void);
#endif
