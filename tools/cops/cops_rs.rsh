...
TEDINFO rs_tedinfo[] =
{ "von Thomas Much, Sven & Wilfried Behne",
  "\0",
  "\0",
...
{ "[1][Keine weiteren Fenster.][Abbruch]",
  ...
  "[3][Nicht gen\201gend Speicher!][OK]",
  ...
  "[1][Beim \231ffnen des Kontrollfelds|ist ein Fehler aufgetreten.][OK]",
  "[2][COPS beenden?][Ja|Nein]",
  "AES noch nicht aktiv.",
  "CPX-Pfad ausw\204hlen",
  "  Kontrollfelder  ",
  " COPS "
};
...
{ 
  ...
  0x0000, 0x0000, 0x0016, 0x000A,
         2,       -1,       -1, G_STRING          ,   /* Object 1 PG_ABOUT */
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  \232ber COPS...",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Einstellungen... ^E",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Neuladen",
  0x0000, 0x0004, 0x0016, 0x0001,
         7,       -1,       -1, G_STRING          ,   /* Object 6 PG_TIDY_UP */
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Aufr\204umen",
  0x0000, 0x0005, 0x0016, 0x0001,
  PG_SELECT_ALL   ,       -1,       -1, G_STRING          ,   /* Object 7  */
  FLAGS10, DISABLED, (LONG)"----------------------",
  0x0000, 0x0006, 0x0016, 0x0001,
         9,       -1,       -1, G_STRING          ,   /* Object 8 PG_SELECT_ALL */
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Alles markieren  ^A",
  0x0000, 0x0007, 0x0016, 0x0001,
  PG_HELP         ,       -1,       -1, G_STRING          ,   /* Object 9  */
  FLAGS10, DISABLED, (LONG)"----------------------",
  0x0000, 0x0008, 0x0016, 0x0001,
         0,       -1,       -1, G_STRING          ,   /* Object 10 PG_HELP */
  SELECTABLE|LASTOB|FLAGS10, NORMAL, (LONG)"  Hilfe          HELP",
  0x0000, 0x0009, 0x0016, 0x0001,
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  \231ffnen       ^O",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Deaktivieren",
  0x0000, 0x0002, 0x0012, 0x0001,
         5,       -1,       -1, G_STRING          ,   /* Object 4 CP_ENABLE */
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Aktivieren",
  ...
  0x0002, 0x0001, 0x001F, 0x0301,
  CIFILE          ,       -1,       -1, G_STRING          ,   /* Object 2  */
  NONE, NORMAL, (LONG)"Dateiname:",
  0x0002, 0x0003, 0x000A, 0x0001,
         4,       -1,       -1, G_STRING          ,   /* Object 3 CIFILE */
  NONE, NORMAL, (LONG)"01234567890123456789",
  0x000D, 0x0003, 0x0014, 0x0001,
  CIVER           ,       -1,       -1, G_STRING          ,   /* Object 4  */
  NONE, NORMAL, (LONG)"Version:",
  0x0004, 0x0004, 0x0008, 0x0001,
         6,       -1,       -1, G_STRING          ,   /* Object 5 CIVER */
  NONE, NORMAL, (LONG)"01234",
  0x000D, 0x0004, 0x0005, 0x0001,
  CIID            ,       -1,       -1, G_STRING          ,   /* Object 6  */
  NONE, NORMAL, (LONG)"Kennung:",
  0x0004, 0x0005, 0x0008, 0x0001,
         8,       -1,       -1, G_STRING          ,   /* Object 7 CIID */
  NONE, NORMAL, (LONG)"0123",
  0x000D, 0x0005, 0x0004, 0x0001,
  CIOK            , CIRAM           , CIAUTO          , G_BUTTON          ,   /* Object 8  */
  FLAGS10, WHITEBAK|STATE9|STATE10|STATE11|STATE12|STATE13|STATE14|STATE15, (LONG)" Konfiguration ",
  0x0002, 0x0007, 0x001F, 0x0007,
  CISET           ,       -1,       -1, G_BUTTON          ,   /* Object 9 CIRAM */
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"RAM-resident",
  0x0002, 0x0002, 0x0018, 0x0001,
  CIBOOT          ,       -1,       -1, G_BUTTON          ,   /* Object 10 CISET */
  FLAGS10, DISABLED|WHITEBAK|STATE15, (LONG)"Nur setzen",
  0x0002, 0x0003, 0x0017, 0x0001,
  CIAUTO          ,       -1,       -1, G_BUTTON          ,   /* Object 11 CIBOOT */
  FLAGS10, DISABLED|WHITEBAK|STATE15, (LONG)"Boot-Init",
  0x0002, 0x0004, 0x0012, 0x0001,
         8,       -1,       -1, G_BUTTON          ,   /* Object 12 CIAUTO */
  SELECTABLE|FLAGS10, WHITEBAK|STATE10|STATE11|STATE15, (LONG)"Automatisch starten",
  0x0002, 0x0005, 0x0013, 0x0001,
  CICANCEL        ,       -1,       -1, G_BUTTON          ,   /* Object 13 CIOK */
  SELECTABLE|DEFAULT|EXIT|FLAGS9|FLAGS10, WHITEBAK, (LONG)"OK",
  0x000D, 0x000F, 0x0009, 0x0101,
         0,       -1,       -1, G_BUTTON          ,   /* Object 14 CICANCEL */
  SELECTABLE|EXIT|LASTOB|FLAGS9|FLAGS10, WHITEBAK, (LONG)"Abbruch",
  0x0018, 0x000F, 0x0009, 0x0101,
  
  /******** Tree 4 SET_DIALOG ****************************************************/
        -1,        1,       10, G_BOX             |0x7100,   /* Object 0  */
  FLAGS10, OUTLINED, (LONG)0x00021100L,
  0x0000, 0x0000, 0x002E, 0x000E,
  ACSELPATH       ,       -1,       -1, G_STRING          ,   /* Object 1  */
  FLAGS10, WHITEBAK|STATE8|STATE9|STATE10|STATE11|STATE12|STATE13|STATE14|STATE15, (LONG)"Einstellungen",
  0x0002, 0x0001, 0x002A, 0x0201,
  ACPATH          ,       -1,       -1, G_BUTTON          ,   /* Object 2 ACSELPATH */
  SELECTABLE|EXIT|FLAGS9|FLAGS10, WHITEBAK|STATE10, (LONG)"CPX-Pfad:",
  0x0002, 0x0003, 0x000B, 0x0101,
  ACBOOT          ,       -1,       -1, G_FTEXT           ,   /* Object 3 ACPATH */
  EDITABLE|FLAGS10, NORMAL, (LONG)&rs_tedinfo[2],
  0x000E, 0x0003, 0x001E, 0x0001,
  ACCLICK         ,       -1,       -1, G_BUTTON          ,   /* Object 4 ACBOOT */
  SELECTABLE|FLAGS10, WHITEBAK|STATE8|STATE10|STATE15, (LONG)"Beim Start ikonifizieren",
  0x0002, 0x0006, 0x001B, 0x0001,
  ACSORTNAME      ,       -1,       -1, G_BUTTON          ,   /* Object 5 ACCLICK */
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"Doppelklick aktiviert CPZ",
  0x0002, 0x0007, 0x001C, 0x0001,
  ACTERM          ,       -1,       -1, G_BUTTON          ,   /* Object 6 ACSORTNAME */
  SELECTABLE|FLAGS10, WHITEBAK|STATE9|STATE11|STATE15, (LONG)"CPXe nach Namen ordnen",
  0x0002, 0x0008, 0x001C, 0x0001,
  ACAFTER         ,       -1,       -1, G_BUTTON          ,   /* Object 7 ACTERM */
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"Beenden nach",
  0x0002, 0x000A, 0x000F, 0x0001,
  ACOK            ,       -1,       -1, G_FTEXT           ,   /* Object 8 ACAFTER */
  EDITABLE|FLAGS10, NORMAL, (LONG)&rs_tedinfo[3],
  0x0012, 0x000A, 0x000C, 0x0001,
        10,       -1,       -1, G_BUTTON          ,   /* Object 9 ACOK */
  SELECTABLE|DEFAULT|EXIT|FLAGS9|FLAGS10, WHITEBAK, (LONG)"OK",
  0x0018, 0x000C, 0x0009, 0x0101,
         0,       -1,       -1, G_BUTTON          ,   /* Object 10  */
  SELECTABLE|EXIT|LASTOB|FLAGS9|FLAGS10, WHITEBAK, (LONG)"Abbruch",
  0x0023, 0x000C, 0x0009, 0x0101,
