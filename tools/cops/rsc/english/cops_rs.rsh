...
TEDINFO rs_tedinfo[] =
{ "by Thomas Much, Sven & Wilfried Behne",
  "\0",
  "\0",
...
{ 
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  About COPS...",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Settings...      ^E",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Reload",
  0x0000, 0x0004, 0x0016, 0x0001,
         7,       -1,       -1, G_STRING          ,   /* Object 6 PG_TIDY_UP */
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Tidy Up",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Open         ^O",
  ...
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Deactivate",
  0x0000, 0x0002, 0x0012, 0x0001,
         5,       -1,       -1, G_STRING          ,   /* Object 4 CP_ENABLE */
  SELECTABLE|FLAGS10, NORMAL, (LONG)"  Activate",
  ...
  FLAGS10, DISABLED|WHITEBAK|STATE15, (LONG)"Set Only",
  0x0002, 0x0003, 0x0017, 0x0001,
  CIAUTO          ,       -1,       -1, G_BUTTON          ,   /* Object 11 CIBOOT */
  FLAGS10, DISABLED|WHITEBAK|STATE8|STATE10|STATE15, (LONG)"Boot Init",
  0x0002, 0x0004, 0x000C, 0x0001,
         8,       -1,       -1, G_BUTTON          ,   /* Object 12 CIAUTO */
  SELECTABLE|FLAGS10, WHITEBAK|STATE8|STATE10|STATE15, (LONG)"Auto Boot",
  0x0002, 0x0005, 0x000C, 0x0001,
  CICANCEL        ,       -1,       -1, G_BUTTON          ,   /* Object 13 CIOK */
  SELECTABLE|DEFAULT|EXIT|FLAGS9|FLAGS10, WHITEBAK, (LONG)"OK",
  0x000D, 0x000F, 0x0009, 0x0101,
         0,       -1,       -1, G_BUTTON          ,   /* Object 14 CICANCEL */
  SELECTABLE|EXIT|LASTOB|FLAGS9|FLAGS10, WHITEBAK, (LONG)"Cancel",
  ...
  FLAGS10, WHITEBAK|STATE8|STATE9|STATE10|STATE11|STATE12|STATE13|STATE14|STATE15, (LONG)"Settings",
  0x0002, 0x0001, 0x0021, 0x0301,
  ACPATH          ,       -1,       -1, G_BUTTON          ,   /* Object 2 ACSELPATH */
  SELECTABLE|EXIT|FLAGS9|FLAGS10, WHITEBAK|STATE10, (LONG)"CPX Path:",
  ...
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"Iconify at start",
  0x0002, 0x0006, 0x001B, 0x0001,
  ACSORTNAME      ,       -1,       -1, G_BUTTON          ,   /* Object 5 ACCLICK */
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"Double click activates CPZ",
  0x0002, 0x0007, 0x001C, 0x0001,
  ACTERM          ,       -1,       -1, G_BUTTON          ,   /* Object 6 ACSORTNAME */
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"Sort Icons by Name",
  0x0002, 0x0008, 0x0015, 0x0001,
  ACAFTER         ,       -1,       -1, G_BUTTON          ,   /* Object 7 ACTERM */
  SELECTABLE|FLAGS10, WHITEBAK|STATE15, (LONG)"Terminate after",
  0x0002, 0x000A, 0x0012, 0x0001,
  ACOK            ,       -1,       -1, G_FTEXT           ,   /* Object 8 ACAFTER */
  EDITABLE|FLAGS10, NORMAL, (LONG)&rs_tedinfo[3],
  0x0015, 0x000A, 0x000C, 0x0001,
