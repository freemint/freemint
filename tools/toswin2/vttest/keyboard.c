...
static void
set_keyboard_layout(const struct natkey *table)
{
  int i, j;
...
{
  /* *INDENT-OFF* */
  static struct natkey const table[] =
  {
    { '"', 1, 12, "\""},
    { '&', 1, 32, "&" },
    { '/', 1, 37, "/" },
...
tst_CursorKeys(MENU_ARGS)
{
  ...
  static const char *const curkeymodes[3] =
  {
...
tst_EditingKeypad(MENU_ARGS)
{
  ...
  static const char *const fnkeymodes[] =
  {
    "Normal mode",
...
tst_NumericKeypad(MENU_ARGS)
{
  ...
  static const char *const fnkeymodes[4] =
  {
    "ANSI Numeric mode",
...
{
  /* *INDENT-OFF* */
  static MENU const keyboardmenu[] = {
