...
long _cdecl emu_scsidrv_CheckDev	(short busno, const llong *SCSIId, char *name, ushort *features);
long _cdecl emu_scsidrv_RescanBus	(short busno);
long _cdecl emu_scsidrv_Open		(short busno, const llong *SCSIId, ulong *maxlen);
