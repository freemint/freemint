...
# define _d_create		(*((long _cdecl (*)(const char *))KENTRY->vec_dos[0x039]))
# define _d_delete		(*((long _cdecl (*)(const char *))KENTRY->vec_dos[0x03a]))
...
# define _f_delete		(*((long _cdecl (*)(const char *))KENTRY->vec_dos[0x041]))
# define _f_seek		(*KENTRY->vec_dos[0x042])
# define _f_attrib		(*KENTRY->vec_dos[0x043])
# define _m_xalloc		(*((long _cdecl (*)(long, short))KENTRY->vec_dos[0x044]))
# define _f_dup			(*KENTRY->vec_dos[0x045])
# define _f_force		(*((long _cdecl (*)(short, short))KENTRY->vec_dos[0x046]))
# define _d_getpath		(*KENTRY->vec_dos[0x047])
# define _m_alloc		(*KENTRY->vec_dos[0x048])
# define _m_free		(*((long _cdecl (*)(long))KENTRY->vec_dos[0x049]))
...
# define _f_rename		(*((long _cdecl (*)(short, const char *, const char *))KENTRY->vec_dos[0x056]))
...
# define _f_select		(*((long _cdecl (*)(unsigned short, long *, long *, long *))KENTRY->vec_dos[0x11d]))
...
# define _f_readlink	(*((long _cdecl (*)(int, char *, const char *))KENTRY->vec_dos[0x12f]))
